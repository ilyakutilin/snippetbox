...
import (
	...
	"snippetbox.mazavrbazavr.ru/internal/models/mocks"
)

// A regular expression which captures the CSRF token value from the HTML
...
func extractCSRFToken(t *testing.T, body string) string {
	...
	// positions.
	matches := csrfTokenRX.FindStringSubmatch(html.UnescapeString(body))
	if len(matches) < 2 {
